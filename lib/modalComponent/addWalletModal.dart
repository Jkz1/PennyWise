...
void showAddWalletModal(BuildContext context, bool isDarkMode) {
  ...
  void addWallet() async {
    ...
    try {
      await walletService.addWallet(walletName, selectedColor.value);
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Wallet '$walletName' added successfully!"),
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(
                      color: FinTrackTheme.primaryColor.withOpacity(0.2),
                    ),
                  ),
                  focusedBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: FinTrackTheme.primaryColor),
                  ),
                ),
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    onTap: () => setModalState(
                      () => selectedColor = selectorColors[index],
                    ),
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: selectedColor == selectorColors[index]
                              ? selectorColors[index]
                              : Colors.transparent,
                          width: 3,
                        ),
                      ),
